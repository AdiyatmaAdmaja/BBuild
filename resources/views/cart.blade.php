    ...
    <body>
        ...
        <section id="cart">
            <section id="menu">
              ...
              <div class="beli">
                <form action="/cart/pengiriman">
                  <h2 class="total">Total Harga: IDR 150.000</h2>
                  <button class="button"><h3>BELI</h3></button>
                </form>
              </div>
            </section>
          </section>
