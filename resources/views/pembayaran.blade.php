    ...
    <body>
        ...
        <section id="pembayaran">
            <div id="pay">
                ...
                <div>
                    <div class="metode">
                        <input class="bank" type="button" id="m1" onclick="m1()" value="Mandiri Virtual Account"></input>
                        <input class="bank" type="button" id="m2" onclick="m2()" value="BCA Virtual Account"></input>
                        <input class="bank" type="button" id="m3" onclick="m3()" value="BRI Virtual Account"></input>
                    </div>

                    <h3 id="RP">Ringkasan Pembayaran</h3>
                    <div id="harga">
                        <p>Total Belanja: IDR 150.000</p>
                        <p>Biaya Admin: IDR 1.000</p>
                        <p id="metode-output"></p>
                    </div>

                    <section id="beli">
                      <form action="/pemesanan">
                        <h3 id="total">Total Harga: IDR 151.000</h3>
                        <button id="button" onclick="showAlert()"><h4>Bayar</h4></button>
                      </form>
                     </section>
                </div>
              </div>
