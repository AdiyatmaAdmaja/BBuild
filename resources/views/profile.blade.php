                ...
                <div id="datadiri">
                  <form action="/profile" method="POST" class="form">
                    ...
                    <div id="left">
                      ...
                      <div id="pilih">
                        <input type="file" name="image" id="image" onchange="previewImage()" accept="image/jpeg, image/png" class="button">
                      </div>
                    </div>
                    ...
                    <div id="right">
                        <h4>Nama:</h4>
                        <input id="nama" class="inputan" type="text" name="nama" placeholder="{{ auth()->user()->username }}" required>
                        <h4>Email:</h4>
                        <input id="email"  class="inputan" type="text" name="email" placeholder="{{ auth()->user()->email }}" required>
                        <h4>No.HP:</h4>
                        <input id="nomor"  class="inputan" type="text" name="hp" placeholder="{{ auth()->user()->hp }}" required>

                        <div id="simpan">
                          <button onclick="showAlert()" type="submit" id="button-1" disabled>SIMPAN</button>
                        </div>
                    </div>
                  </form>
                </div>
