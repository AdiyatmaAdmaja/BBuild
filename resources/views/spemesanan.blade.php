      ...
      <div id="cari">
        ...
        <section id="spemesanan">
            <section id="menu">
              ...
              <div id="status">
                <div class="status" id="nav-1">Pesanan Diproses</div>
                <div class="status" id="nav-2">Pesanan Dikirim</div>
                <div class="status" id="nav-3">Pesanan Sampai</div>
                <div class="status" id="nav-4">Pesanan Selesai</div>
              </div>

              <section id="section-0">
                <h3 class="text">Semua Pesanan Anda:</h3>
              </section>

              <section id="section-1">
                <div id="item-1">
                    <section class="item-cart">
                      <a href="/produk" target="_blank"><img class="img" src="https://d2xjmi1k71iy2m.cloudfront.net/dairyfarm/id/images/980/0998009_PE822911_S3.jpg"></a>
                      <h3>Lorem</h3>
                      <h4>Jumlah: 1</h4>
                    </section>
                    <section class="item-cart">
                      <img class="img" src="https://d2xjmi1k71iy2m.cloudfront.net/dairyfarm/id/images/980/0998009_PE822911_S3.jpg">
                      <h3>Lorem</h3>
                      <h4>Jumlah: 1</h4>
                    </section>
                    <section class="item-cart">
