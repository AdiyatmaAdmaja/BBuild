            ...
            <div id="main">
              <div id="display">
                ...
                <div id="atur">
                  ...
                  <h4 class="jumlah">Jumlah Barang: {{ $produk->jumlah_barang }}</h4>
                    <form class="atur" action="#">
                      <input id="number" onkeyup="sum();" onclick="sum()" value="0" class="number" type="number" min="1" max="100">
                      <h4 class="price" id="price"></h4>
                      <button class="cart" id="press" onclick="showAlert()" type="submit">+ Keranjang</button>
                    </form>
                </div>
                ...
                <div id="detail">
                  ...
                  <h4 class="text-1">Harga: Rp.{{ $produk->harga_barang }}</h4>
